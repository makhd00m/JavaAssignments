...
public class ArticlesController {
    ...
    ResponseEntity<String> getAllArticles() {
        // TODO 05:
        //  1. call articleService.getAllArticles()
        ...
        //  4. add filter by date range `?from=2021-01-01&to=2024-01-01`
    ...
    ResponseEntity<Void> getArticleById() {
        // TODO 06:
        //  1. call articleService.getArticleById()
    ...
    ResponseEntity<String> createArticle(
        ...
        // TODO 08:
        //  1. create a CreateArticleDTO (containing title, description, body, tags)
        ...
        return ResponseEntity.accepted().body("Articles created by " + username + " successfully!!!");
    }
